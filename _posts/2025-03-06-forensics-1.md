...
layout: post
title: Forensics 1
tags: NME forensics learn beginner-friendly ctf jeopardy featured
author: Jakob Nacanaynay, Bill Nguyen, Parth Mittal, Claude
pretty-date: 6 March, 2025
excerpt: discover hidden information within files, systems, or data
---
...
Creators often hide flags in metadata fields that aren't immediately visible when viewing a file. A good utility for viewing EXIF data is exiftool.
...
Stego challenges may require password extraction from other parts of the challenge. For years, I have referred to [0xRick’s list of steganography tools](https://0xrick.github.io/lists/stego/) for common steg-solving programs. [Aperisolve](https://aperisolve.com/) is another tool which will automate many steganography and analysis operations.
...
Often, the challenges will consist of looking through dumps for files, programs, and running processes containing [cool](https://youtu.be/Ej-Nr79bVjg) information.

## Tools

- [CyberChef](https://gchq.github.io/CyberChef/) - Quickly convert encodings
- [0xRick Steganography](https://0xrick.github.io/lists/stego/) - List of steganography commands
- [Aperisolve](https://aperisolve.com/) - Automate several basic steganography tasks
- [Autopsy](https://www.autopsy.com/) - Analyze disk images
- [Volatility](https://github.com/volatilityfoundation/volatility) - Analyze memory dumps
...
- [CTF Handbook - Forensics](https://ctf101.org/forensics/overview/)

## Practice Problems on picoCTF
